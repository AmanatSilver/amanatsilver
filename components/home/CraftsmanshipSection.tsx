    ...
    <section className="bg-stone-900 text-stone-100 py-20 md:py-32 overflow-hidden" data-scroll-section>
      <div className="container mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-center">
        ...
        <div className="max-w-2xl">
          ...
          <h3 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-light mb-6 md:mb-8 leading-none serif italic tracking-tighter text-stone-100">Permanent <br/>By Design.</h3>
          <p className="text-stone-400 text-base sm:text-lg font-light leading-relaxed mb-8 md:mb-12 max-w-lg">{craftsmanshipDescription}</p>
