  ...
  if (loading) {
    return (
      <div className="h-screen w-full flex items-center justify-center bg-stone-50">
        <div className="text-[10px] uppercase tracking-[0.4em] animate-pulse">Searching...</div>
      </div>
    );
  }
    ...
    <div className="pt-40 pb-32 bg-stone-50 min-h-screen" data-scroll-section>
      <div className="container mx-auto px-6">
        <header className="mb-24 text-center max-w-2xl mx-auto" data-scroll data-scroll-speed="0.5">
          <h1 className="text-6xl font-light mb-8 serif gsap-fade-up">Search Results</h1>
        ...
        {products.length === 0 && (
          <div className="text-center py-20">
            <p className="text-stone-400 text-lg">No products found matching "{query}"</p>
            <Link to="/collections" className="inline-block mt-8 text-sm uppercase tracking-wider text-stone-600 hover:text-stone-900 transition-colors">
              Browse all products →
            </Link>
          </div>
        )}
